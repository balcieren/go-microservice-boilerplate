...
func (uu *UserUpdate) SetNillableAge(u *uint64) *UserUpdate {
	if u != nil {
		uu.SetAge(*u)
	}
	return uu
...
func (uu *UserUpdate) AddAge(u int64) *UserUpdate {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.AgeCleared() {
		_spec.ClearField(user.FieldAge, field.TypeUint64)
	}
...
// SetNillableAge sets the "age" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableAge(u *uint64) *UserUpdateOne {
	if u != nil {
		uuo.SetAge(*u)
	}
	return uuo
...
// AddAge adds u to the "age" field.
func (uuo *UserUpdateOne) AddAge(u int64) *UserUpdateOne {
